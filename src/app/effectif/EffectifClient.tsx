...
const POSITION_COLORS: Record<string, string> = {
  ...
  ATT: "text-[#C8102E] border-[#C8102E]/30 bg-[#C8102E]/10",
};
...
function PlayerCard({ player, index }: { player: Player; index: number }) {
  return (
    <motion.div
      ...
      className="group bg-[#141414] hover:bg-[#1A1A1A] border border-white/5 hover:border-[#C8102E]/20 rounded-2xl overflow-hidden transition-all cursor-pointer"
    >
      {/* Avatar */}
      ...
      <div className="p-4">
        ...
        <h3 className="text-white font-black uppercase leading-tight" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
          ...
          <span className="text-xl group-hover:text-[#C8102E] transition-colors">{player.name}</span>
        </h3>
        ...
        <div className="grid grid-cols-3 gap-2 mt-4 pt-3 border-t border-white/5 text-center">
          ...
          <div>
            <div className="text-[#C8102E] font-black text-lg leading-none flex items-center justify-center gap-0.5" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
